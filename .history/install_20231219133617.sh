...
git clone https://github.com/fwartner/homeassistant-config.git $HOME/Development/Smarthome/homeassistant-config
git clone https://github.com/fwartner/home-assistant-wakewords-collection $HOME/Development/Smarthome/home-assistant-wakewords-collection
